...
from Model.MvkGAN import MvKGAN
...
if __name__ == '__main__':
    ...
    """
    *********************************************************
    Load Data_example from data_generator function.
    """
    config = dict()
    ...
    if args.model_type in ['mvkgan', 'cfkg']:
    ...
    *********************************************************
    ...
    if args.model_type in ['mvkgan']:
        model = MvKGAN(data_config=config, pretrain_data=pretrain_data, args=args)
    ...
    *********************************************************
    ...
    if args.save_flag == 1:
        ...
        elif args.model_type in ['ncf', 'nfm', 'mvkgan']:
    ...
    if args.pretrain == 1:
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            if args.report != 1:
                ...
                # *********************************************************
                # save the pretrained model parameters of mvkgan (i.e., user & item & kg embeddings) for pretraining other models.
                if args.save_flag == -2:
                    ...
                    print('save the weights of mvkgan in path: ', temp_save_path)
                    exit()
    ...
    *********************************************************
    ...
    for epoch in range(args.epoch):
        ...
        """
        *********************************************************
        Alternative Training for MvkGAN:
