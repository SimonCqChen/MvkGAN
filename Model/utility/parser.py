...
def parse_args():
    parser = argparse.ArgumentParser(description="Run MvkGAN.")
    parser.add_argument('--weights_path', nargs='?', default='',
                        help='Store model path.')
    parser.add_argument('--data_path', nargs='?', default='../Data_example/',
    ...
    parser.add_argument('--model_type', nargs='?', default='mvkgan',
                        help='Specify a loss type from {mvkgan, bprmf, fm, nfm, cke, cfkg}.')
    ...
    parser.add_argument('--high_level_conv', type=int, default=3,
                        help='high level convolution iteration time')
